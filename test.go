...
import (
	"fmt"
	"github.com/speakeasy-sdks/jacob-test/v3/internal/hooks"
	"github.com/speakeasy-sdks/jacob-test/v3/pkg/utils"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *Test {
	sdk := &Test{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "3.1.2",
			GenVersion:        "2.272.4",
			UserAgent:         "speakeasy-sdk/go 3.1.2 2.272.4 1.0.0 github.com/speakeasy-sdks/jacob-test",
			Hooks:             hooks.New(),
		},
	}
